...
### Setting directories
scrapewd <- "C:/Users/ahutc/OneDrive - University of Tennessee/Policy Uncertainty Index/Data/toscrape_epu"
cleanwd <- "C:/Users/ahutc/OneDrive - University of Tennessee/Policy Uncertainty Index/Data"
htmlwd <- "C:/Users/ahutc/OneDrive - University of Tennessee/Policy Uncertainty Index/Webpages"
...
setwd(cleanwd)
write.csv(newsbank, file = "epu_indices_apr25.csv")
...
#fig is the graph object that you'll need to export

### Saving figure as HTML
saveWidget(fig, file ="epuindex.html", selfcontained = TRUE)

### Uploading figure to GitHub
post_github()